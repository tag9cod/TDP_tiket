<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Home - Tri Adhi Gunawan</title>
        ...
        <link href="{{ asset('assets/css/colors/purple.css') }}" rel="stylesheet" id="color-opt">
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-half-260 w-100 d-table" data-jarallax='{"speed": 0.5}' style="background: url('assets/images/event/gue.jpg') center center;">
            <div class="bg-overlay bg-primary bg-gradient" style="opacity: 0.85;"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <div class="title-heading">
                            <h1 class="display-4 title-dark text-white fw-bold mb-3">Tiket Konser</h1>
                            <p class="para-desc title-dark mx-auto text-light">Belinya Disini Aja...!</p>                    
                            <div class="row">
                            ...
                            <a href="{{ route('form.pesan.tiket') }}" class="btn btn-success mt-2 me-2"><i class="uil uil-ticket"></i> Beli Tiket ?</a>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
