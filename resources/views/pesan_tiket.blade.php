                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="page-next-level">
                            ...
                            <a href="../" class="sub-menu-item">Kembali Beranda</a>
                            <div class="page-next">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="nama_pemesan" id="name" type="text" class="form-control ps-5" placeholder="Nama Anda :">
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="email" id="email" type="email" class="form-control ps-5" placeholder="Email Anda :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="no_telp" id="no_telp" type="no_telp" class="form-control ps-5" placeholder="No. Telp Anda :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                        <div class="col-md-6">
